...
public class KysymyksenLisäysnäkymäKuuntelija implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        JLabel aihepiiri = new JLabel("Aihepiiri: ");
        JTextField aihepiiriKentta = new JTextField();
        JButton lisaaNappi = new JButton("Lisää kysymys!");
        KysymyksenLisäysKuuntelija kuuntelija = new KysymyksenLisäysKuuntelija(m, oikeavastausKentta, kysymysKentta, aihepiiriKentta, container);
        ...
        container.add(aihepiiri);
        container.add(aihepiiriKentta);
