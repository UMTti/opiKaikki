...
public class PääValikkoPanel extends JPanel {
    ...
    private void luoKomponentit() {
     ...
     public static ArrayList<Moduuli> luoModuulit() {
        ...
        Moduuli K = new Moduuli("K-moduuli", "txttiedostot/k.txt", "txttiedostot/kvastaukset.txt");
        moduulit.add(K);
        Moduuli t1 = new Moduuli("T1-moduuli", "txttiedostot/tmoduuli.txt", "txttiedostot/tmoduulivastaukset.txt");
        moduulit.add(t1);
        Moduuli t2 = new Moduuli("T2-moduuli", "txttiedostot/t2moduuli.txt", "txttiedostot/t2moduulivastaukset.txt");
        moduulit.add(t2);
        return moduulit;
    }
}
